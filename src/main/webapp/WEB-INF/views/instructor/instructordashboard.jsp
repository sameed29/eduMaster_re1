...
<body>
    ...
    <main class="main">
        ...
        <div class="content">
            ...
            <!-- 2) ACTIONS: 4 in one line -->
            <section class="row row-4" style="margin-bottom:2.5rem;">
                <a href="createCourse.jsp" class="card action-card">
                ...
                <a href="courseContent.jsp" class="card action-card">
                    <div class="action-top">
                ...
                <a href="assignments.jsp" class="card action-card">
                    <div class="action-top">
                ...
                <a href="studentQA.jsp" class="card action-card">
                    <div class="action-top">
